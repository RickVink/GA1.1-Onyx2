...
The function 'add' sums two variables. Call the function with the variables you want to add.
For example: add(1,4) = 5

Extension function distance_from_zero returns Euclidian distance of any number from zero.
...
Function sumlist(values)
    For loop function to iterate through a list of numbers
